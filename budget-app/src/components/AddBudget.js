        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Modal.Body>
                <Form.Group className='mb-3'>
                    ...
                    <Form.Control type='text' placeholder='Enter budget name' controlId='name'  ref={nameRef} required />
                </Form.Group>
                <Form.Group className='mb-3'>
                    <Form.Label>Max Budget</Form.Label>
                    <Form.Control type='number' placeholder='Enter max budget' controlId='maxBudget' min='0' step='0.01' ref={maxBudgetRef} required />
                </Form.Group>
            </Modal.Body>
            <Modal.Footer>
